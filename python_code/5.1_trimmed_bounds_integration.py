...
if __name__ == "__main__":
    ...
    folder_path = r'C:\Users\rcaller\Documents\GitHub\Performance-Regression-Plots\text_files'  
...
#6      25.3760          2.68414  12.2851    10.3191      8    2 
    ...
    plt.savefig('Albany Piro wall time', dpi =300)
    ...
    for timer in timers:
        ...
        plt.savefig(f'Efficiency {timer}', dpi =300)
